  ...
  return (
    <>
      <style>{`
        ...
        .card-glow:hover .profile-ring::after {
          opacity: 1;
        }
      ...
      <div className="feedback-card mt-2 card-glow relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 mb-16 mx-4 overflow-hidden">
        ...
        <div className="flex items-start gap-5 mb-6 mt-2">
          <div className="profile-ring relative flex-shrink-0">
            ...
            {/* Online Status Badge */}
            <div className="absolute bottom-0 right-0 w-5 h-5 bg-secondary rounded-full border-3 border-gray-900 shadow-lg"></div>
          </div>
          
          <div className="flex-1 pt-1">
            <h6 className="text-white font-bold text-xl mb-1.5 tracking-tight">
              {name}
            </h6>
        ...
        <div className="absolute top-5 right-5 w-20 h-20 border-t-2 border-r-2 border-secondary/20 rounded-tr-3xl pointer-events-none"></div>
        <div className="absolute bottom-5 left-5 w-20 h-20 border-b-2 border-l-2 border-emerald-500/20 rounded-bl-3xl pointer-events-none"></div>
      </div>
    </>
  );
}